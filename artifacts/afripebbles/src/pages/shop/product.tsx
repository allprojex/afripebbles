            ...
            {product.availability === 'preorder' && (
              <div className="flex items-start gap-3 bg-primary/5 p-4 rounded-xl mb-6 border border-primary/20">
                ...
                <div className="text-sm text-foreground/80 space-y-1">
                  ...
                  {product.preorderOpensAt && (
                    <p>Ordering opens {format(new Date(product.preorderOpensAt), 'MMMM d, yyyy')}.</p>
                  )}
                  {product.preorderClosesAt && (
                    <p>Ordering closes {format(new Date(product.preorderClosesAt), 'MMMM d, yyyy')}.</p>
                  )}
                  <p>
            ...
            <div className="mt-auto pt-4">
              {product.externalPurchaseUrl ? (
                ...
                <Link href={enquiryHref}>
                  <Button size="lg" className="w-full rounded-full h-14 text-lg gap-2" disabled={!orderable && product.availability !== 'coming_soon' && product.availability !== 'out_of_stock'}>
