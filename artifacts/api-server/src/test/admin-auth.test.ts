...
const ADMIN_ROUTES: { method: "get" | "post" | "put" | "patch" | "delete"; path: string }[] = [
  ...
  { method: "get", path: "/api/admin/ugc-entries" },
  { method: "post", path: "/api/admin/ugc-entries" },
  { method: "get", path: "/api/admin/ugc-entries/1" },
  { method: "put", path: "/api/admin/ugc-entries/1" },
  { method: "delete", path: "/api/admin/ugc-entries/1" },
  { method: "get", path: "/api/admin/testimonials" },
  { method: "post", path: "/api/admin/testimonials" },
  { method: "get", path: "/api/admin/testimonials/1" },
  { method: "put", path: "/api/admin/testimonials/1" },
  { method: "delete", path: "/api/admin/testimonials/1" },
